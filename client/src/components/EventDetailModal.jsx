...
const EventDetailModal = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg p-8 w-full max-w-2xl relative shadow-xl max-h-[90vh] overflow-y-auto">
        <button
          onClick={onClose}
          className="absolute right-4 top-4 text-slate-400 hover:text-slate-600 text-2xl font-bold w-10 h-10 flex items-center justify-center rounded-lg hover:bg-slate-100 transition-colors cursor-pointer"
        >
          ×
        </button>
        ...
        <div className="space-y-3 mb-6">
          <div className="flex items-start p-4 bg-slate-50 rounded-lg border border-slate-200">
            ...
            <div>
              ...
              <p className="text-slate-600 text-sm">at {selectedEvent.time}</p>
            </div>
          </div>
          ...
          <div className="flex items-start p-4 bg-slate-50 rounded-lg border border-slate-200">
            ...
            <div>
              ...
              <p className="text-slate-900 font-medium mt-1 break-words">
        ...
        {selectedEvent.tickets && selectedEvent.tickets.length > 0 ? (
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-lg p-6 text-center">
            <p className="text-3xl mb-3 font-bold text-slate-700">Info</p>
