...
const Home = () => {
    return (
        <section className="relative flex items-center justify-between min-h-screen bg-white overflow-hidden">
            <div className="absolute left-0 top-0 w-[60%] h-full bg-rose-400 rounded-r-[50%]"></div>
            ...
            <div className="relative z-10 w-1/2 px-16 py-2 flex flex-col justify-center text-white gap-4">
                ...
                <Link
                    to="/login"
                    className="bg-white text-rose-500 px-6 py-3 rounded-lg font-semibold shadow hover:bg-rose-50/80 transition-all w-fit"
                >
                    Get Started
                </Link>
            </div>
