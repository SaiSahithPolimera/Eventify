                ...
                <div className="bg-white rounded-2xl shadow-xl p-8 space-y-6 backdrop-blur-sm bg-opacity-90">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className={`w-full cursor-pointer py-3 px-4 rounded-lg font-medium text-white transition-all duration-200 ${isLoading
                                ? 'bg-pink-400'
                    ...
                    <p className="text-center text-sm text-gray-600">
                        ...
                        <Link
                            to="/signup"
                            className="font-medium text-pink-600 hover:text-pink-700 transition-colors cursor-pointer"
                        >
                            Sign up
                        </Link>
                    </p>
